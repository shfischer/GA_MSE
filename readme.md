Optimising empirical management procedures with MSE and Genetic
Algorithms
================

This is the branch used during WKLIFE 10 in 2020. Other branches might
be more up to date and include more detailed descriptions.

## Introduction

This repository contains the code for testing empirical management
procedures and optimising them with a genetic algorithm. The simulation
is based on the Fisheries Library in R
...
The [`master`](https://github.com/shfischer/GA_MSE/tree/master) branch
contains the code for optimising the rfb rule for the publication:
...
The [`PA`](https://github.com/shfischer/GA_MSE/tree/PA) branch (mirrored
at [`GA_MSE_PA`](https://github.com/shfischer/GA_MSE_PA)) includes the
optimisation of the rfb rule with specific risk limits for the ICES
...
branch (mirrored at
[`GA_MSE_HR`](https://github.com/shfischer/GA_MSE_HR)) contains the
optimisation for the harvest rate rule.
...
See the other branches for a description of the repository contents.
